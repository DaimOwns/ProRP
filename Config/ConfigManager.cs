...
namespace Reality.Config
{
    public static class ConfigManager
    {
        ...
        public static void Initialize(string ConfigPath)
        {
            ...
            // MUS
            mConfigData.Add("mus.bind.ip", new ConfigElement("mus.bind.ip", ConfigElementType.IpAddress, IPAddress.Any));
            mConfigData.Add("mus.bind.port", new ConfigElement("mus.bind.port", ConfigElementType.Integer, 23));
            mConfigData.Add("mus.commander.ip", new ConfigElement("mus.commander.ip", ConfigElementType.IpAddress, "127.0.0.1"));
            // General
