            ...
            lock (mItems)
            {
                ...
                foreach (Item Item in mItems.Values)
                {
                    ...
                    switch (Item.Definition.Behavior)
                    {
                        ...
                        case ItemBehavior.BattleBanzai:
                            if (Item.Definition.Name.ToLower() == "bb_gate_r")
                            {
                                Effect = new RoomTileEffect(RoomTileEffectType.Effect, 0, Item.RoomPosition.GetVector2(), 0, 33);
                            }
                            if (Item.Definition.Name.ToLower() == "bb_gate_g")
                            {
                                Effect = new RoomTileEffect(RoomTileEffectType.Effect, 0, Item.RoomPosition.GetVector2(), 0, 34);
                            }
                            if (Item.Definition.Name.ToLower() == "bb_gate_b")
                            {
                                Effect = new RoomTileEffect(RoomTileEffectType.Effect, 0, Item.RoomPosition.GetVector2(), 0, 35);
                            }
                            if (Item.Definition.Name.ToLower() == "bb_gate_y")
                            {
                                Effect = new RoomTileEffect(RoomTileEffectType.Effect, 0, Item.RoomPosition.GetVector2(), 0, 36);
                            }
