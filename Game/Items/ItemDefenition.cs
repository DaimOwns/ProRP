...
namespace Reality.Game.Items
{
    ...
    public class ItemDefinition
    {
        ...
        public bool Usable
        {
            get
            {
                if (Behavior == ItemBehavior.Arrow || Behavior == ItemBehavior.Dice || Behavior == ItemBehavior.ExchangeItem || Behavior == ItemBehavior.Fireworks || Behavior == ItemBehavior.HoloDice || Behavior == ItemBehavior.Gate || Behavior == ItemBehavior.OneWayGate || Behavior == ItemBehavior.Moodlight || Behavior == ItemBehavior.Seat || Behavior == ItemBehavior.StickyNote || Behavior == ItemBehavior.Teleporter || Behavior == ItemBehavior.TraxPlayer || Behavior == ItemBehavior.Wired || Behavior == ItemBehavior.WiredCondition || Behavior == ItemBehavior.WiredEffect || Behavior == ItemBehavior.WiredTrigger)
                {
                    return true;
                }
                else
